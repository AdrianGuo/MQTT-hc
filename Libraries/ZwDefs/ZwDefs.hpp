...
/******************************************************************************/
#define BASIC_TYPE_CONTROLLER           0x01 /* ZwNode is a portable controller */
#define BASIC_TYPE_ROUTING_SLAVE        0x04 /* ZwNode is a slave with routing capabilities */
#define BASIC_TYPE_SLAVE                0x03 /* ZwNode is a slave */
#define BASIC_TYPE_STATIC_CONTROLLER    0x02 /* ZwNode is a static controller */
...
#define SPECIFIC_TYPE_SECURE_KEYPAD_DOOR_LOCK                                            0x03 /*Door Lock (keypad â€“lever) Device Type*/
#define SPECIFIC_TYPE_SECURE_KEYPAD_DOOR_LOCK_DEADBOLT                                   0x04 /*Door Lock (keypad â€“ deadbolt) Device Type*/
...
#define SPECIFIC_TYPE_NOT_USED                                                           0x00 /*Specific Device Class not used*/
#define SPECIFIC_TYPE_NOTIFICATION_SENSOR           
...
/* found AtPosition Z-Wave Alliance web site along with           */
/* sample icons.                                          */
...
#define ICON_TYPE_GENERIC_REPEATER_SLAVE                                                0x1B00   //Repeater Device Type 
...
#define MFG_ID_ADVANCED_OPTRONIC_DEVICES_COLTD                                          0x016C   //Advanced Optronic Devices Co.,Ltd
...
#define MFG_ID_BONIG_UND_KALLENBACH_OHG                                                 0x0169   //BÃ¶nig und Kallenbach oHG
...
#define MFG_ID_BUILDING_36                                         0x0190   //Building 36
...
#define MFG_ID_CBCC_SARL                                           0x0166   //CBCC Sarl
...
#define MFG_ID_HUAPIN_INFORMATION_TECHNOLOGY_COLTD                 0x0180   //Huapin Information Technology Co.,Ltd
...
#define MFG_ID_MODSTROM                                            0x008D   //ModstrÃ¸m
...
#define MFG_ID_RADEMACHER_GERATEELEKTRONIK_GMBH_CO_KG              0x0142   //Rademacher GerÃ¤te-Elektronik GmbH & Co. KG
...
#define MFG_ID_TERRA_OPTIMA_BV_TIDLIGERE_PRIMAIR_SERVICES          0x005C   //Terra Optima B.V. (tidligere Primair Services)
...
#define MGF_ID_HOMECONTROL_INDIA                                                        0x0293   // 
...
/* Values used for ZwNode Info Cached Get command */
...
/* Values used for ZwNode Info Cached Report command */
...
/* Values used for ZwNode Add Status command */
...
/* ZwNode Naming command class commands */
...
/* Values used for ZwNode Naming ZwNode Location Report command */
...
/* Values used for ZwNode Naming ZwNode Location Set command */
...
/* Values used for ZwNode Naming ZwNode Name Report command */
...
/* Values used for ZwNode Naming ZwNode Name Set command */
...
/* Values used for Powerlevel Test ZwNode Report command */
...
/* Values used for Powerlevel Test ZwNode Set command */
...
/* Values used for Zip Inv ZwNode Solicitation command */
...
/* Values used for Zip ZwNode Advertisement command */
...
/* Values used for Command Application ZwNode Info Set command */
#define COMMAND_APPLICATION_NODE_INFO_SET_SECURITY_SCHEME_0_MARK                         0xF100
/* Values used for Command Application ZwNode Info Report command */
...
#define MAILBOX_QUEUE_FLUSH                                                              0x06
...
#define KEX_FAIL_KEY_REPORT                                                              0x01
#define KEX_FAIL_SCHEME                                                                  0x02
#define KEX_FAIL_CURVES                                                                  0x03
#define KEX_FAIL_TIMEOUT                                                                 0x04
#define KEX_FAIL_PUB_KEY                                                                 0x05
#define KEX_FAIL_CANCEL                                                                  0x06
#define KEX_FAIL_AUTH                                                                    0x07
#define KEX_FAIL_KEY_GET                                                                 0x08
#define KEX_FAIL_KEY_VERIFY                                                              0x09
#define KEX_FAIL_KEY_SET                                                                 0x0A
