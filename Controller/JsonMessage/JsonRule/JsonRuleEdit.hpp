...
#ifndef JSON_RULE_EDIT_HPP_
#define JSON_RULE_EDIT_HPP_
...
class JsonRuleEdit: public JsonMessageBase {
public:
	typedef struct {
		i32_t devid;
		u8_t ord;
