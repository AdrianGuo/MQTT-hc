...
JsonSelfZwaveSession_p JsonSelfZwaveSession::m_pInstance = NULL;
 ...
 * @retval None
 */
JsonSelfZwaveSession_p
JsonSelfZwaveSession::CreateSession() {
    if (m_pInstance == NULL) {
        m_pInstance = new JsonSelfZwaveSession();
    }
    return m_pInstance;
}
