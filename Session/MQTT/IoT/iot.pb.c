...
const pb_field_t Model_DeviceLocation_fields[7] = {
...
const pb_field_t Model_DeviceAlert_fields[6] = {
...
const pb_field_t Model_DeviceMeasurements_fields[5] = {
...
const pb_field_t IoT_fields[1] = {
    PB_LAST_FIELD
};

const pb_field_t IoT_Header_fields[3] = {
    PB_FIELD(  1, UENUM   , REQUIRED, STATIC  , FIRST, IoT_Header, command, command, 0),
    PB_FIELD(  2, STRING  , OPTIONAL, STATIC  , OTHER, IoT_Header, originator, command, 0),
    PB_LAST_FIELD
};

const pb_field_t IoT_RegisterDevice_fields[5] = {
    PB_FIELD(  1, STRING  , REQUIRED, STATIC  , FIRST, IoT_RegisterDevice, hardwareId, hardwareId, 0),
    PB_FIELD(  2, STRING  , REQUIRED, STATIC  , OTHER, IoT_RegisterDevice, specificationToken, hardwareId, 0),
    PB_FIELD(  3, MESSAGE , REPEATED, CALLBACK, OTHER, IoT_RegisterDevice, metadata, specificationToken, &Model_Metadata_fields),
    PB_FIELD(  4, STRING  , OPTIONAL, STATIC  , OTHER, IoT_RegisterDevice, siteToken, metadata, 0),
    PB_LAST_FIELD
};

const pb_field_t IoT_Acknowledge_fields[3] = {
    PB_FIELD(  1, STRING  , REQUIRED, STATIC  , FIRST, IoT_Acknowledge, hardwareId, hardwareId, 0),
    PB_FIELD(  2, STRING  , OPTIONAL, STATIC  , OTHER, IoT_Acknowledge, message, hardwareId, 0),
    PB_LAST_FIELD
};

const pb_field_t IoT_DeviceStreamDataRequest_fields[4] = {
    PB_FIELD(  1, STRING  , REQUIRED, STATIC  , FIRST, IoT_DeviceStreamDataRequest, hardwareId, hardwareId, 0),
    PB_FIELD(  2, STRING  , REQUIRED, STATIC  , OTHER, IoT_DeviceStreamDataRequest, streamId, hardwareId, 0),
    PB_FIELD(  3, FIXED64 , REQUIRED, STATIC  , OTHER, IoT_DeviceStreamDataRequest, sequenceNumber, streamId, 0),
    PB_LAST_FIELD
};
 ...
 * field descriptors.
 */
PB_STATIC_ASSERT((pb_membersize(Model_DeviceLocation, metadata[0]) < 65536 && pb_membersize(Model_DeviceAlert, metadata[0]) < 65536 && pb_membersize(Model_DeviceMeasurements, measurement[0]) < 65536 && pb_membersize(Model_DeviceMeasurements, metadata[0]) < 65536 && pb_membersize(Model_DeviceStream, metadata[0]) < 65536 && pb_membersize(Model_DeviceStreamData, metadata[0]) < 65536 && pb_membersize(IoT_RegisterDevice, metadata) < 65536), YOU_MUST_DEFINE_PB_FIELD_32BIT_FOR_MESSAGES_Model_Model_Metadata_Model_DeviceLocation_Model_DeviceAlert_Model_Measurement_Model_DeviceMeasurements_Model_DeviceStream_Model_DeviceStreamData_IoT_IoT_Header_IoT_RegisterDevice_IoT_Acknowledge_IoT_DeviceStreamDataRequest_Device_Device_Header_Device_RegistrationAck_Device_DeviceStreamAck)
#endif
 ...
 * 8 bit descriptors.
 */
PB_STATIC_ASSERT((pb_membersize(Model_DeviceLocation, metadata[0]) < 256 && pb_membersize(Model_DeviceAlert, metadata[0]) < 256 && pb_membersize(Model_DeviceMeasurements, measurement[0]) < 256 && pb_membersize(Model_DeviceMeasurements, metadata[0]) < 256 && pb_membersize(Model_DeviceStream, metadata[0]) < 256 && pb_membersize(Model_DeviceStreamData, metadata[0]) < 256 && pb_membersize(IoT_RegisterDevice, metadata) < 256), YOU_MUST_DEFINE_PB_FIELD_16BIT_FOR_MESSAGES_Model_Model_Metadata_Model_DeviceLocation_Model_DeviceAlert_Model_Measurement_Model_DeviceMeasurements_Model_DeviceStream_Model_DeviceStreamData_IoT_IoT_Header_IoT_RegisterDevice_IoT_Acknowledge_IoT_DeviceStreamDataRequest_Device_Device_Header_Device_RegistrationAck_Device_DeviceStreamAck)
#endif
