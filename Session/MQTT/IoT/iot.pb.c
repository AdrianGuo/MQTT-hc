...
const Model_AlertLevel Model_DeviceAlert_alertLevel_default = Model_AlertLevel_Info;
...
const pb_field_t Model_DeviceLocation_fields[8] = {
    ...
    PB_FIELD(  2, DOUBLE  , REQUIRED, STATIC  , OTHER, Model_DeviceLocation, latitude, hardwareId, 0),
    PB_FIELD(  3, DOUBLE  , REQUIRED, STATIC  , OTHER, Model_DeviceLocation, longitude, latitude, 0),
    PB_FIELD(  4, DOUBLE  , OPTIONAL, STATIC  , OTHER, Model_DeviceLocation, elevation, longitude, 0),
...
const pb_field_t Model_DeviceAlert_fields[8] = {
    ...
    PB_FIELD(  9, UENUM   , OPTIONAL, STATIC  , OTHER, Model_DeviceAlert, alertLevel, updateState, &Model_DeviceAlert_alertLevel_default),
    PB_LAST_FIELD
};
...
const pb_field_t Model_Measurement_fields[3] = {
    ...
    PB_FIELD(  2, DOUBLE  , REQUIRED, STATIC  , OTHER, Model_Measurement, measurementValue, measurementId, 0),
    PB_LAST_FIELD
};
...
const pb_field_t IotEvent_fields[1] = {
    PB_LAST_FIELD
};

const pb_field_t IotEvent_Header_fields[3] = {
    PB_FIELD(  1, UENUM   , REQUIRED, STATIC  , FIRST, IotEvent_Header, command, command, 0),
    PB_FIELD(  2, STRING  , OPTIONAL, STATIC  , OTHER, IotEvent_Header, originator, command, 0),
    PB_LAST_FIELD
};

const pb_field_t IotEvent_RegisterDevice_fields[5] = {
    PB_FIELD(  1, STRING  , REQUIRED, STATIC  , FIRST, IotEvent_RegisterDevice, hardwareId, hardwareId, 0),
    PB_FIELD(  2, STRING  , REQUIRED, STATIC  , OTHER, IotEvent_RegisterDevice, specificationToken, hardwareId, 0),
    PB_FIELD(  3, MESSAGE , REPEATED, CALLBACK, OTHER, IotEvent_RegisterDevice, metadata, specificationToken, &Model_Metadata_fields),
    PB_FIELD(  4, STRING  , OPTIONAL, STATIC  , OTHER, IotEvent_RegisterDevice, siteToken, metadata, 0),
    PB_LAST_FIELD
};

const pb_field_t IotEvent_Acknowledge_fields[3] = {
    PB_FIELD(  1, STRING  , REQUIRED, STATIC  , FIRST, IotEvent_Acknowledge, hardwareId, hardwareId, 0),
    PB_FIELD(  2, STRING  , OPTIONAL, STATIC  , OTHER, IotEvent_Acknowledge, message, hardwareId, 0),
    PB_LAST_FIELD
};

const pb_field_t IotEvent_DeviceStreamDataRequest_fields[4] = {
    PB_FIELD(  1, STRING  , REQUIRED, STATIC  , FIRST, IotEvent_DeviceStreamDataRequest, hardwareId, hardwareId, 0),
    PB_FIELD(  2, STRING  , REQUIRED, STATIC  , OTHER, IotEvent_DeviceStreamDataRequest, streamId, hardwareId, 0),
    PB_FIELD(  3, FIXED64 , REQUIRED, STATIC  , OTHER, IotEvent_DeviceStreamDataRequest, sequenceNumber, streamId, 0),
    PB_LAST_FIELD
};
 ...
 * field descriptors.
 */
PB_STATIC_ASSERT((pb_membersize(Model_DeviceLocation, metadata[0]) < 65536 && pb_membersize(Model_DeviceAlert, metadata[0]) < 65536 && pb_membersize(Model_DeviceMeasurements, measurement[0]) < 65536 && pb_membersize(Model_DeviceMeasurements, metadata[0]) < 65536 && pb_membersize(Model_DeviceStream, metadata[0]) < 65536 && pb_membersize(Model_DeviceStreamData, metadata[0]) < 65536), YOU_MUST_DEFINE_PB_FIELD_32BIT_FOR_MESSAGES_Model_Model_Metadata_Model_DeviceLocation_Model_DeviceAlert_Model_Measurement_Model_DeviceMeasurements_Model_DeviceStream_Model_DeviceStreamData_IotEvent_IotEvent_Header_IotEvent_RegisterDevice_IotEvent_Acknowledge_IotEvent_DeviceStreamDataRequest_Device_Device_Header_Device_RegistrationAck_Device_DeviceStreamAck)
#endif
 ...
 * 8 bit descriptors.
 */
PB_STATIC_ASSERT((pb_membersize(Model_DeviceLocation, metadata[0]) < 256 && pb_membersize(Model_DeviceAlert, metadata[0]) < 256 && pb_membersize(Model_DeviceMeasurements, measurement[0]) < 256 && pb_membersize(Model_DeviceMeasurements, metadata[0]) < 256 && pb_membersize(Model_DeviceStream, metadata[0]) < 256 && pb_membersize(Model_DeviceStreamData, metadata[0]) < 256), YOU_MUST_DEFINE_PB_FIELD_16BIT_FOR_MESSAGES_Model_Model_Metadata_Model_DeviceLocation_Model_DeviceAlert_Model_Measurement_Model_DeviceMeasurements_Model_DeviceStream_Model_DeviceStreamData_IotEvent_IotEvent_Header_IotEvent_RegisterDevice_IotEvent_Acknowledge_IotEvent_DeviceStreamDataRequest_Device_Device_Header_Device_RegistrationAck_Device_DeviceStreamAck)
#endif
